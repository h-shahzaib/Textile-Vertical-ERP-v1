...
namespace ExpenseManager.Ledgers.NazyOtherLedgerGroup
{
    ...
    /// </summary>
    public partial class NazyOtherLedgerEntryRow : UserControl
    {
        NazyOtherLedger ledger;

        public NazyOtherLedgerEntryRow(NazyOtherLedger ledger)
        {
            InitializeComponent();
            this.ledger = ledger;
        ...
        private void DeleteRow()
        {
            HelperMethods.AskYesNo(async () =>
               await MainWindow.NazyOtherLedgerManager.RemoveData(ledger.ID));
        }
        ...
        private void Ledger_Detail_Row_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            var runningBal = MainWindow.rawDataManager.NazyOtherLedgers
